<div w-class="page" ev-detail-back="detailBack" on-tap="close" style="height:100%">
    <div w-class="searchBox">
        ...
        <div style="display:flex;align-items: center;margin-top: 20px;">
            ...
            <div style="display:inline-block;margin-left: 25px;" ev-dateBox-change="changeDateBox" ev-date-change="changeDate">
                <widget w-tag="app-components-periodPicker">{showDateBox:{{it.expandIndex[0]}},startDate:{{it.endTime}} }</widget>
            </div>
        </div>
    </div>
