...
import { getOrderReason } from '../../net/pull';
...
// ['商品ID','商品名称','SKU编号','SKU名称','供应商商品ID','商品类型','所属分类','购买数量','保质期','成本价','售价','会员价','退货地址','收件人','联系电话','供货价']
...
export class OrderDetail extends Widget {
    public props:Props = {
        ...
        goodsTitleList:['商品ID','商品名称','SKU编号','SKU名称','供应商商品ID','商品类型','所属分类','购买数量','保质期','成本价','售价','会员价','退货地址','收件人','联系电话','供货价'],  // 商品信息标题
