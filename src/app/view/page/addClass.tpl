<div class="new-page" w-class="page" ev-detail-back="detailBack" on-tap="close">
    ...
    <div w-class="searchBox">
        ...
        <div style="padding-bottom: 20px;display:flex;justify-content: space-between;">
            <div w-class="tab" style="width:auto" ev-input-change="firstNameChange">
                ...
                <widget w-tag="app-components-input">{placeHolder:"输入分类名字",style:"border:1px solid #eee;",input:{{it.firstName}},disabled:{{it.currentData.name? true: false}}}</widget>
            </div>
    ...
    <div w-class="searchBox">
        ...
        <div w-class="filterBoxItem">
            {{if it.currentData.children.length>0}}
            ...
            {{if it.addClass}}
            <div w-class="typeItem">
                <div w-class="tab" ev-input-change="secondNameChange(e)">
                    <widget w-tag="app-components-input">{placeHolder:"输入分类名字",style:"border:1px solid #eee;"}</widget>
                </div>
    ...
    <div w-class="ctr">
        ...
        <div w-class="btn" on-tap="delClass">删除</div>
        {{end}}
